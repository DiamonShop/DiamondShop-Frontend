                            ...
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/Nhan">Nhẫn</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-details-des">
                                            ...
                                            <div class="price-box">
                                                <span class="price-regular">{productObj.productObj.newPrice}</span>
                                                <span class="price-old"><del>{productObj.productObj.oldPrice}</del></span>
                                            </div>
                                            <ul class="diamond-filter-container">
                                                ...
                                                <li class="filter-group " >
                                                    <Link to='/Huongdandoni'>Hướng dẫn do ni</Link>
                                                </li>
                                               
                                            </ul>
                                            
                                                <div class="action_link">
                                                    <a class="btn btn-cart2" href="/Giohang">Thêm vào giỏ hàng</a>
                                                </div>
