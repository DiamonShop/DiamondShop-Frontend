                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="widget-item">
                            ...
                            <div className="widget-body">
                                <p>Chúng tôi là đội ngũ chuyên cung cấp các dòng trang sức cao cấp  </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6">
                    ...
                    <div className="col-md-6">
                        <div className="newsletter-wrapper">
                            ...
                            <form className="newsletter-inner" id="mc-form">
                                <input type="email" className="news-field" id="mc-email" autocomplete="off" placeholder="Nhập email của bạn"/>
